...
public:
    ...
    typedef std::function< void(const system::error_code&, SrcSocket&&, const system::error_code& write_ec_, SrcSocket&& )> completion_handler;
...
private:
    void finish()
    {
        ...
        {
            finished_ = true;
            completion_( read_ec_, std::move(src_socket_), write_ec_, std::move(dst_socket_) );
        }
